...
import { Search, X, Mail, Calendar, ShieldCheck, Phone, Power, Loader2, RefreshCcw, Clock, ChevronLeft, ChevronRight } from 'lucide-react';
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem', marginTop: '1.5rem' }}>
                    ...
                    {[...Array(totalPages)].map((_, i) => (
                        <button
                            ...
                            style={{ minWidth: '2.25rem', height: '2.25rem', padding: 0, border: '1px solid', borderColor: currentPage === i + 1 ? 'transparent' : '#e2e8f0', borderRadius: '0.5rem', background: currentPage === i + 1 ? 'var(--primary-gradient)' : '#fff', color: currentPage === i + 1 ? '#fff' : '#475569', fontWeight: 600, fontSize: '0.875rem' }}
                        >
                            {i + 1}
                        </button>
                    ))}
